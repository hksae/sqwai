...
| I4 | resolve_ref; validator refs; pre-edit warning; stale markers; reflector executor tool | partial — resolve_ref, validator refs, pre-edit warning, rich provenance and freshness done; stale markers done (newly-stale acceptance gets one durable chat row per turn, deduped, re-armed on re-verify); the reflector executor is H1 work (§12.7) | I2, I3, F1 |
